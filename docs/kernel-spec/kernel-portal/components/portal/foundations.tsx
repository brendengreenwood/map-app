...
export function TypographySection() {
  ...
  return (
    <Section
      ...
      eyebrow="Foundations"
      title="Typography"
      lead="No web fonts, by design — the system renders in each OS's native UI typeface (San Francisco, Segoe UI, Roboto), with a monospace stack for code, IDs, and tabular data. Zero network requests, instant paint, native everywhere. The size ramp runs from dense table meta to display."isplay."
    >
      <div className="grid gap-4 sm:grid-cols-2">
        {families.map((f) => (
