...
function Combobox() {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger render={<Button variant="outline" className="w-[220px] justify-between"> {frameworks.find((f) => f.value === value)?.label ?? "Select…"} <ChevronsUpDown className="opacity-50" /> </Button>} />
